...
abstract class Store implements ActiveRecordInterface
{
    ...
    /**
     * The value for the store_pk field.
     *
     * @var        int
     */
    protected $store_pk;
    ...
    /**
     * Get the [store_pk] column value.
     *
     * @return int
     */
    public function getStorePk()
    {
        return $this->store_pk;
    }
    ...
    public function setStorePk($v)
    {
        ...
        if ($this->store_pk !== $v) {
            $this->store_pk = $v;
            $this->modifiedColumns[StoreTableMap::COL_STORE_PK] = true;
        }
    ...
    public function setStoreChainFk($v)
    {
        ...
        if ($this->store_chain_fk !== $v) {
            ...
            $this->modifiedColumns[StoreTableMap::COL_STORE_CHAIN_FK] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[StoreTableMap::COL_NAME] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[StoreTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setZipCode($v)
    {
        ...
        if ($this->zip_code !== $v) {
            $this->zip_code = $v;
            $this->modifiedColumns[StoreTableMap::COL_ZIP_CODE] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[StoreTableMap::COL_CITY] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[StoreTableMap::COL_PHONE] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[StoreTableMap::COL_EMAIL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StoreTableMap::translateFieldName('StorePk', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store_pk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StoreTableMap::translateFieldName('StoreChainFk', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store_chain_fk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StoreTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StoreTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StoreTableMap::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zip_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : StoreTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : StoreTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : StoreTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[StoreTableMap::COL_STORE_PK] = true;
        if (null !== $this->store_pk) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . StoreTableMap::COL_STORE_PK . ')');
        }
        if (null === $this->store_pk) {
            try {
                $dataFetcher = $con->query("SELECT nextval('store_store_pk_seq')");
                $this->store_pk = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(StoreTableMap::COL_STORE_PK)) {
            $modifiedColumns[':p' . $index++]  = 'store_pk';
        }
        if ($this->isColumnModified(StoreTableMap::COL_STORE_CHAIN_FK)) {
            $modifiedColumns[':p' . $index++]  = 'store_chain_fk';
        }
        if ($this->isColumnModified(StoreTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(StoreTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'address';
        }
        if ($this->isColumnModified(StoreTableMap::COL_ZIP_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'zip_code';
        }
        if ($this->isColumnModified(StoreTableMap::COL_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'city';
        }
        if ($this->isColumnModified(StoreTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(StoreTableMap::COL_EMAIL)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'store_pk':
                        $stmt->bindValue($identifier, $this->store_pk, PDO::PARAM_INT);
                        break;
                    case 'store_chain_fk':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getStorePk(),
            $keys[1] => $this->getStoreChainFk(),
            $keys[2] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setStorePk($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setStoreChainFk($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StoreTableMap::COL_STORE_PK)) {
            $criteria->add(StoreTableMap::COL_STORE_PK, $this->store_pk);
        }
        if ($this->isColumnModified(StoreTableMap::COL_STORE_CHAIN_FK)) {
            $criteria->add(StoreTableMap::COL_STORE_CHAIN_FK, $this->store_chain_fk);
        }
        if ($this->isColumnModified(StoreTableMap::COL_NAME)) {
            $criteria->add(StoreTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(StoreTableMap::COL_ADDRESS)) {
            $criteria->add(StoreTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(StoreTableMap::COL_ZIP_CODE)) {
            $criteria->add(StoreTableMap::COL_ZIP_CODE, $this->zip_code);
        }
        if ($this->isColumnModified(StoreTableMap::COL_CITY)) {
            $criteria->add(StoreTableMap::COL_CITY, $this->city);
        }
        if ($this->isColumnModified(StoreTableMap::COL_PHONE)) {
            $criteria->add(StoreTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(StoreTableMap::COL_EMAIL)) {
            $criteria->add(StoreTableMap::COL_EMAIL, $this->email);
        }
    ...
    /**
     * Generic method to set the primary key (store_pk column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStorePk(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function getStoreChain(ConnectionInterface $con = null)
    {
        if ($this->aStoreChain === null && ($this->store_chain_fk !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStoreChain->addStores($this);
             */
        }
    ...
    {
        if (null !== $this->aStoreChain) {
            $this->aStoreChain->removeStore($this);
        }
        $this->store_pk = null;
