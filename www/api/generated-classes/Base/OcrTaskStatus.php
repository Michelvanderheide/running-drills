...
/**
 * Base class that represents a row from the 'ocr_task_status' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class OcrTaskStatus implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OcrTaskStatusTableMap';
    ...
    /**
     * The value for the ocr_task_status_pk field.
     *
     * @var        int
     */
    protected $ocr_task_status_pk;

    /**
     * The value for the status_name field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\OcrTaskStatus object.
     */
    ...
    /**
     * Compares this with another <code>OcrTaskStatus</code> instance.  If
     * <code>obj</code> is an instance of <code>OcrTaskStatus</code>, delegates to
     * <code>equals(OcrTaskStatus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OcrTaskStatus The current object, for fluid interface
     */
    ...
    /**
     * Get the [ocr_task_status_pk] column value.
     *
     * @return int
     */
    public function getOcrTaskStatusPk()
    {
        return $this->ocr_task_status_pk;
    }

    /**
     * Get the [status_name] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [ocr_task_status_pk] column.
     *
     * @param int $v new value
     * @return $this|\OcrTaskStatus The current object (for fluent API support)
     */
    public function setOcrTaskStatusPk($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->ocr_task_status_pk !== $v) {
            $this->ocr_task_status_pk = $v;
            $this->modifiedColumns[OcrTaskStatusTableMap::COL_OCR_TASK_STATUS_PK] = true;
        }
    ...
    /**
     * Set the value of [status_name] column.
     *
    ...
    public function setStatusName($v)
    {
        ...
        if ($this->status_name !== $v) {
            $this->status_name = $v;
            $this->modifiedColumns[OcrTaskStatusTableMap::COL_STATUS_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OcrTaskStatusTableMap::translateFieldName('OcrTaskStatusPk', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ocr_task_status_pk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OcrTaskStatusTableMap::translateFieldName('StatusName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_name = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = OcrTaskStatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\OcrTaskStatus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOcrTaskStatusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OcrTaskStatus::setDeleted()
     * @see OcrTaskStatus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOcrTaskStatusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OcrTaskStatusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OcrTaskStatusTableMap::COL_OCR_TASK_STATUS_PK)) {
            $modifiedColumns[':p' . $index++]  = 'ocr_task_status_pk';
        }
        if ($this->isColumnModified(OcrTaskStatusTableMap::COL_STATUS_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'status_name';
        }

        $sql = sprintf(
            'INSERT INTO ocr_task_status (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ocr_task_status_pk':
                        $stmt->bindValue($identifier, $this->ocr_task_status_pk, PDO::PARAM_INT);
                        break;
                    case 'status_name':
                        $stmt->bindValue($identifier, $this->status_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = OcrTaskStatusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getOcrTaskStatusPk();
                break;
            case 1:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['OcrTaskStatus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OcrTaskStatus'][$this->hashCode()] = true;
        $keys = OcrTaskStatusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOcrTaskStatusPk(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setOcrTaskStatusPk($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setStatusName($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OcrTaskStatusTableMap::COL_OCR_TASK_STATUS_PK)) {
            $criteria->add(OcrTaskStatusTableMap::COL_OCR_TASK_STATUS_PK, $this->ocr_task_status_pk);
        }
        if ($this->isColumnModified(OcrTaskStatusTableMap::COL_STATUS_NAME)) {
            $criteria->add(OcrTaskStatusTableMap::COL_STATUS_NAME, $this->status_name);
        }
    ...
    {
        $criteria = ChildOcrTaskStatusQuery::create();
        $criteria->add(OcrTaskStatusTableMap::COL_OCR_TASK_STATUS_PK, $this->ocr_task_status_pk);
    ...
    {
        $validPk = null !== $this->getOcrTaskStatusPk();
    ...
    /**
     * Generic method to set the primary key (ocr_task_status_pk column).
     *
    ...
    {
        return null === $this->getOcrTaskStatusPk();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OcrTaskStatus (or compatible) type.
    ...
    {
        $copyObj->setOcrTaskStatusPk($this->getOcrTaskStatusPk());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OcrTaskStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildOcrTaskStatus is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOcrTaskStatus The current object (for fluent API support)
     */
    public function setOcrTasks(Collection $ocrTasks, ConnectionInterface $con = null)
    {
        ...
        foreach ($ocrTasksToDelete as $ocrTaskRemoved) {
            $ocrTaskRemoved->setOcrTaskStatus(null);
        }
     ...
     * Otherwise if this OcrTaskStatus is new, it will return
     * an empty collection; or if this OcrTaskStatus has previously
     * been saved, it will retrieve related OcrTasks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OcrTaskStatus.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildOcrTask[] List of ChildOcrTask objects
     */
    public function getOcrTasksJoinProduct(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOcrTaskQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(OcrTaskStatusTableMap::DEFAULT_STRING_FORMAT);
    }
